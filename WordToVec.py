...
class WordToVec():
    ...
    def __generate_sentences_file(self):
        ...
        lines_tokenized = [[word.lower() for word in nltk.word_tokenize(line) if word.isalpha()] for line in lines if line]
    ...
    def write_vectors(sentences_file_path, vectors_file_path):
        ...
        model = Word2Vec(sentences, vector_size=50, window=15, min_count=1, workers=4)
